...
#             ]
#         else:
#             base_transforms += [transforms.CenterCrop((128, 128))]
...
# train_path = r"C:\Users\lala deepika\Desktop\final_dataset\Datasets\Split Dataset\train"
# val_path = r"C:\Users\lala deepika\Desktop\final_dataset\Datasets\Split Dataset\val"
...
class ResNet3DClassifier:
    def __init__(self, model_path, device):
        ...
        self.model.fc = nn.Sequential(
            nn.Dropout(0.6),
            nn.Linear(self.model.fc.in_features, 5)
        )
